(()=>{
  const PATCH='4.6-bootstrap-20260914-27';
  ...
  if(!mullPanel){
    ...
    mullPanel.innerHTML='<h2>3. マリガン自動抽出</h2><p id="mulliganStatus43" class="help">最新版を読み込み中…</p><div id="mulliganDetail43" class="ocrRead">v4.6 を準備しています。</div>';
    const anchor=prepPanel||$q('#scanTurns')?.closest('.panel');if(anchor)anchor.parentNode.insertBefore(mullPanel,anchor.nextSibling);
  }
  function load46(){
    if(window.__wb46Loading||window.__wb46Loaded)return;window.__wb46Loading=true;
    const s=document.createElement('script');s.src='./fix-v4.6.js?v=4.6-20260914-27';s.dataset.wbLatest='46';
    s.onload=()=>{window.__wb46Loaded=true;try{log('patch-v46-bootstrap-loaded',{patch:PATCH})}catch{}};
  ...
  function load431(){
    ...
    window.__wb431Loading=true;const s=document.createElement('script');s.src='./fix-v4.3.1.js?v=4.3.1-20260914-17l';s.dataset.wbLatest='431';
  ...
  load431();try{log('patch-v46-root-bootstrap',{patch:PATCH})}catch{}
})();