(()=>{
'use strict';
const APP={version:'4.11.0',build:'4.11.0-20260918-clean-11',revision:'clean-11'};
...
function init(){
  const sub=document.querySelector('header p');if(sub)sub.textContent='Build 2026.09.18-clean-11 / 攻撃可能リング・盤面確定打点';
  WB.video=WB.$('#video');
