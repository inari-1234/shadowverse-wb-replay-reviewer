(()=>{
'use strict';
const APP={version:'4.11.0',build:'4.11.0-20260918-clean-07',revision:'clean-07'};
...
function init(){
  const sub=document.querySelector('header p');if(sub)sub.textContent='Build 2026.09.18-clean-07 / 先頭ターン誤検出補正・資源判定保護';
  WB.video=WB.$('#video');
