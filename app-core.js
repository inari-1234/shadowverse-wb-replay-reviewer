(()=>{
'use strict';
const APP={version:'4.11.0',build:'4.11.0-20260918-clean-10',revision:'clean-10'};
...
function init(){
  const sub=document.querySelector('header p');if(sub)sub.textContent='Build 2026.09.18-clean-10 / 盤面攻撃力観測・顔打点安全化';
  WB.video=WB.$('#video');
