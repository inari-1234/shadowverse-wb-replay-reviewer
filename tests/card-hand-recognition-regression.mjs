...
assert.equal(H.decideHandSamples(qb816).recognized.quickBlader?.decision,'temporal-image-cost-hypothesis-consensus','actual v4.13.16 QB sequence must recover from OCR instability');
...
assert.equal(H.decideHandSamples(bb816).recognized.barbaros?.decision,'temporal-image-cost-hypothesis-consensus','actual v4.13.16 Barbaros sequence must recover from weak displayed-cost crops');
