...
const overlapCandidate=(normal,masked,index,{title=.313,support=.70,gap=43,runnerNormal=.48,runnerMasked=.60,crossZeta=.28,crossBarbaros=.47,ocrValue=null,ocrAccepted=false,ocrConfidence=null,templateValue=null,templateAccepted=false}={})=>({sampleTime:0,candidateCount:6,counts:{},scores:{},candidates:[{index:2,matchScores:{quickBlader:{anchorScore:runnerNormal,imageScore:runnerNormal,titleScore:.32}},shadowMatchScores:{quickBlader:{score:runnerMasked,supportRatio:support,rightGap:gap},zetaBeatrix:{score:.20,supportRatio:support,rightGap:gap},barbaros:{score:.25,supportRatio:support,rightGap:gap}},geometry:{rightGapToCostCenter:gap},displayedCost:{}},{index,matchScores:{quickBlader:{anchorScore:normal,imageScore:normal,titleScore:title},zetaBeatrix:{anchorScore:.30,imageScore:.30,titleScore:.20},barbaros:{anchorScore:.35,imageScore:.35,titleScore:.20}},shadowMatchScores:{quickBlader:{score:masked,supportRatio:support,rightGap:gap},zetaBeatrix:{score:crossZeta,supportRatio:support,rightGap:gap},barbaros:{score:crossBarbaros,supportRatio:support,rightGap:gap}},geometry:{rightGapToCostCenter:gap},displayedCost:{ocrValue,ocrAccepted,ocrConfidence,templateValue,templateAccepted},imageBest:{cardId:'quickBlader',imageScore:normal,imageSource:'anchor',anchorScore:normal,titleScore:title,shadowMaskedAnchor:{score:masked,supportRatio:support,rightGap:gap}},best:{cardId:'quickBlader',imageScore:normal,imageSource:'anchor',anchorScore:normal,titleScore:title}}]});
...
assert.equal(qbOverlapDecision.recognized.quickBlader?.overlapMasked?.groups?.[0]?.minObservedGain,.1126);
