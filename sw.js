const CACHE='wb-review-v4-6-20260914-27';
const ASSETS=['./','./index.html','./manifest.webmanifest','./fix-v3.7.js','./fix-v3.7.1.js','./fix-v3.9.js','./fix-v3.9.1.js','./fix-v3.9.2.js','./fix-v4.0.js','./fix-v4.1.js','./fix-v4.2.js','./fix-v4.3.js','./fix-v4.3.1.js','./fix-v4.4.js','./fix-v4.4.1.js','./fix-v4.4.2.js','./fix-v4.4.3.js','./fix-v4.6.js'];
