...
const MANAGED_SW_REGISTER="if('serviceWorker'in navigator){log('service-worker-register-managed',{mode:'canonical-root-sw-v4108-41'})}";
...
function patchHtml(text){
  ...
  const scripts='<script src="./fix-v4.10.2-pre.js?v=4.10.4-pre-20260915-16b"></script>'+ 
    ...
    '<script src="./fix-v4.10.8.4.js?v=4.10.8.4-20260917-20i"></script>';
