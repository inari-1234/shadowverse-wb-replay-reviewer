const CACHE='wb-review-v4-10-8-20260917-38';
const BUILD='4.10.8-20260917-20f';
...
const MANAGED_SW_REGISTER="if('serviceWorker'in navigator){log('service-worker-register-managed',{mode:'canonical-root-sw-v4108-38'})}";
...
function patchHtml(text){
  ...
  const scripts='<script src="./fix-v4.10.2-pre.js?v=4.10.4-pre-20260915-16b"></script>'+ 
    ...
    '<script src="./fix-v4.10.8.3.js?v=4.10.8.3-20260917-20f"></script>';
