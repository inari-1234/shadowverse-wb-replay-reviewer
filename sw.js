const CACHE='wb-review-v4-10-4-20260916-25';
...
function patchHtml(text){
  ...
  const scripts='<script src="./fix-v4.10.2-pre.js?v=4.10.4-pre-20260915-16b"></script>'+ 
    ...
    '<script src="./fix-v3.9.2.js?v=3.9.2-20260916-stable-12"></script>'+ 
    ...
    '<script src="./fix-v4.3.js?v=4.7.0-bootstrap-20260916-07"></script>'+ 
